...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=234694597ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=neko&table=image_tag">`neko`.`image_tag`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=neko&table=tag">`neko`.`tag`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=neko&table=image">`neko`.`image`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5178434a796f7e7d6256217b54447b42">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `neko`.`tag` ( `id` INT NOT NULL AUTO_INCREMENT ,  `name` TEXT NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tag`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="neko" targettable="image">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `neko`.`image` ( `id` INT NOT NULL AUTO_INCREMENT ,  `url` TEXT NULL ,  `sfw` BOOLEAN NOT NULL ,  `translation` TEXT NULL DEFAULT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="neko" targettable="image">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `image`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="neko" targettable="image_tag">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `neko`.`image_tag` ( `image_id` INT NOT NULL ,  `tag_id` INT NOT NULL ,    INDEX  (`image_id`),    INDEX  (`tag_id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="neko" targettable="image_tag">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `image_tag`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="neko" targettable="tag">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `image_tag`  
ORDER BY `image_tag`.`tag_id` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="neko" targettable="image_tag">
                            <div class="action_content">
